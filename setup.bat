@echo off
title Koni Story Bot by @MeoMunDep
color 0A
...
cls
echo =================================================================
echo    Koni Story BOT SETUP AND RUN SCRIPT by @MeoMunDep
echo =================================================================
echo.
...
if exist "..\node_modules" (
    ...
    npm install user-agents axios p-limit meo-forkcy-colors meo-forkcy-proxy meo-forkcy-utils
    cd %~dp0
) else (
